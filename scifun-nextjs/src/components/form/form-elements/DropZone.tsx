...
const DropzoneComponent: React.FC<DropzoneProps> = ({
  ...
  return (
    <div
      className={`transition border border-dashed cursor-pointer dark:hover:border-brand-500 rounded-xl hover:border-brand-500 ${errorClasses}`}
    >
      <form
        {...getRootProps()}
      ...
      >
        ...
        <div className="dz-message flex flex-col items-center m-0!">
          ...
          <span className=" text-center mb-5 block w-full max-w-[290px] text-sm text-gray-700 dark:text-gray-400">
            Kéo và thả ảnh PNG, JPG, WebP, SVG của bạn vào đây hoặc duyệt
          </span>
