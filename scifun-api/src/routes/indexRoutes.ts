...
import {
  ...
  getSubmissionDetail,
  getResults,
} from "../controllers/quizSubmissionController";
import {
  addFavoriteQuiz,
  removeFavoriteQuiz,
  getFavoriteQuizzes,
} from "../controllers/favoriteQuizController";
import {
  createVideoLesson,
  updateVideoLesson,
  deleteVideoLesson,
...
router.put(
  "/quiz/update-quiz/:_id",
  authMiddleware,
  checkRole("ADMIN"),
  updateQuiz
);
router.delete(
  "/quiz/delete-quiz/:_id",
  authMiddleware,
  checkRole("ADMIN"),
  deleteQuiz
);
...
router.get(
  "/submission/get-submissionDetail/:submissionId",
  getSubmissionDetail
);
...
router.put(
  "/video-lesson/update/:id",
  authMiddleware,
  checkRole("ADMIN"),
  updateVideoLesson
);
router.delete(
  "/video-lesson/delete/:id",
  authMiddleware,
  checkRole("ADMIN"),
  deleteVideoLesson
);
